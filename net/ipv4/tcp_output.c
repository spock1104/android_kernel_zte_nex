...
-------- 	----	   -----------------------------				----------------------
2012-12-28   wangcheng Set the tcp windows size >64k scale>6        ZTE_WANGCHENG_TCP_20121228
...
int sysctl_socket_rwin_init __read_mostly;
...
/*ZTE_LC_TCP_WIN, 20130205 start*/
/*
		//ZTE_WANGCHENG_TCP_20121228 add
		*rcv_wscale = 6;    
		*rcv_wnd = 65535U;
		(*window_clamp)= 65535U;
*/
       if (sysctl_socket_rwin_init > 0)
         {
             *rcv_wnd = sysctl_socket_rwin_init;
         }
/*ZTE_LC_TCP_WIN, 20130205 end*/
}
