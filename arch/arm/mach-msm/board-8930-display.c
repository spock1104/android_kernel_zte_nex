...
#ifdef CONFIG_FB_MSM_MIPI_WARPLTE_OTM_VIDEO_WVGA_PT_PANEL
static int warplte_blk_gpio[] = {DISP_BACKLIGHT_GPIO};

static struct mipi_dsi_panel_platform_data warplte_pdata = {
	.gpio = warplte_blk_gpio,
};

static struct platform_device mipi_dsi_warplte_panel_device = {
	.name = "mipi_warplte",
	.id = 0,
	.dev = {
		.platform_data = &warplte_pdata,
	}
};
#endif
...
#ifdef CONFIG_FB_MSM_MIPI_WARPLTE_OTM_VIDEO_WVGA_PT_PANEL
printk("lizhiye, msm8930_init_fb, mipi_dsi_warplte_panel_device\n");
	platform_device_register(&mipi_dsi_warplte_panel_device);
#endif
