...
static struct clk_lookup msm_clocks_8930[] = {
	...
	CLK_LOOKUP("mem_clk",		rpm_msg_ram_p_clk.c,	""),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-001a"),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0036"),//add by wt for ov8825 and ov8835
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-003c"),//add by yanwei for ov5640
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0010"),//add by yanwei for ov970	
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-005a"),//add by sx for hi542
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-003d"),//add by sx for sp0a28	
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0064"),//add by sx for ar0542
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-006c"),
	CLK_LOOKUP("cam_clk",		cam1_clk.c,	"4-0048"),
	CLK_LOOKUP("cam_clk",		cam2_clk.c,		NULL),
	CLK_LOOKUP("cam_clk",		cam0_clk.c,	"4-0020"),
