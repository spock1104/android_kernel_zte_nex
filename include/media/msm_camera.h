...
#define MSM_CAM_IOCTL_FLASH_MODE_CTRL \
		_IOW(MSM_CAM_IOCTL_MAGIC, 68, struct led_mode_t *)
//wangtao add for otp info
#define MSM_CAM_IOCTL_GET_SENSOR_OTP \
	_IOR(MSM_CAM_IOCTL_MAGIC, 69, struct msm_camsensor_info *)
	
#define MSM_CAM_IOCTL_ACTUATOR_IO_CFG_MACRO \
	_IOR(MSM_CAM_IOCTL_MAGIC, 70, struct msm_camsensor_info *)
...
#define V4L2_CID_CAF          (V4L2_CID_PRIVATE_BASE+20)  //add by yanwei
#define V4L2_CID_GET_PREVIEW_EXPOSURE_GAIN_VALUE          (V4L2_CID_PRIVATE_BASE+21)  //add by yanwei 
...
#define CFG_SET_PRE_FLASH_GAIN_VALUE  57
#define CFG_GET_PRE_FLASH_GAIN_VALUE  58
#define CFG_GET_FLASH_FLAG                       59
#define CFG_MAX                       60
//HT ADD
#define CFG_MOVE_FOCUS_MACRO	       61
#define MOVE_NEAR	0
#define MOVE_FAR	1
...
enum msm_v4l2_brightness_mode { //yanwei add
