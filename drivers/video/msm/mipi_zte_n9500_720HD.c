...
static int mipi_lcd_on(struct platform_device *pdev)
{
	...
	switch(LcdPanleID)
	{				
		case LCD_PANEL_4P5_OTM1280_OT_CMI:	//310
			printk("LCD: LCD_PANEL_4P5_OTM1280_OT_CMI\n");
			mipi_dsi_cmds_tx(&mipi_tx_buf, cmi_display_on_cmds, ARRAY_SIZE(cmi_display_on_cmds));
			break;
		case LCD_PANEL_4P5_OTM1281_OT_TRULY:	//311
			printk("LCD: LCD_PANEL_4P5_OTM1281_OT_TRULY\n");
			mipi_dsi_cmds_tx(&mipi_tx_buf, truly_display_on_cmds, ARRAY_SIZE(truly_display_on_cmds));
			break;		
		default:
...
//		pinfo.clk_rate = 38900000;	//51907008;
		...
		pinfo.lcdc.h_back_porch = 120;//100;
